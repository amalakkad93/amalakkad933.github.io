...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    setLoading(true);
    // Optional: Add custom logic here if needed before form submission
  };
    ...
    <div className="-mt-[8rem] xl:flex-row flex-col-reverse flex gap-10 overflow-hidden">
      ...
      <motion.div
        ...
        <div className="contact-info mb-8 flex items-center justify-between">
          ...
          <a href="https://www.linkedin.com/in/anas-alakkad-a0b9371b3" target="_blank" rel="noopener noreferrer" className="flex items-center text-timberWolf">
        ...
        <form
          action="https://formspree.io/f/xayrnnpd" // Your Formspree URL
          method="POST"
          ref={formRef}
